...
public class Flcliapi {
    ...
    private static class Agent {
        ...
        private void routerMessage() {
            ...
            if (!sequenceStr.equals("PONG") && Integer.parseInt(sequenceStr) == sequence) {
                reply.push("OK");
                reply.send(pipe);
                if (request != null) {
                    request.destroy();
    ...
    static private class FreelanceAgent implements IAttachedRunnable {
        ...
        public void run(Object[] args, ZContext ctx, Socket pipe) {
            ...
            poller.register(agent.pipe, ZMQ.Poller.POLLIN);
            poller.register(agent.router, ZMQ.Poller.POLLIN);
